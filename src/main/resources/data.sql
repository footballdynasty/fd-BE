...
INSERT INTO team(id, name, coach, username, conference, is_human, image_url) values('5a9ac517-4494-44fb-8c69-02bebeac5259', 'Eastern Michigan', 'Will Myers', 'myerswj163', 'MAC', true, 'https://dxbhsrqyrr690.cloudfront.net/sidearm.nextgen.sites/emueagles.com/images/responsive_2021/nav_main_logo.svg') ON CONFLICT DO NOTHING;
...
INSERT INTO team(id, name, coach, username, conference, is_human, image_url) values('c0f2932f-f2f9-4fbd-a5d7-1038e6fcb45a', 'Miami-OH', 'Bradley Critchlow', 'apple_lucky144', 'MAC', true, 'https://dxbhsrqyrr690.cloudfront.net/sidearm.nextgen.sites/miamiredhawks.com/images/nav_logo.svg') ON CONFLICT DO NOTHING;
...
INSERT INTO team(id, name, coach, username, conference, is_human, image_url) values('e93cfd20-77df-4c16-9827-00057f12098f', 'Buffalo', 'Eric Critchlow', 'The-Eric-C', 'MAC', true, 'https://dxbhsrqyrr690.cloudfront.net/sidearm.nextgen.sites/ubbulls.com/images/responsive_2019/main_logo.svg') ON CONFLICT DO NOTHING;
